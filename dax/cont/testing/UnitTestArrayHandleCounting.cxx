...
void TestCountingArray()
{
  ...
  dax::cont::ArrayHandleCounting<dax::Id> arrayConst(0,ARRAY_SIZE);
  dax::cont::ArrayHandleCounting<dax::Id> arrayMake = dax::cont::make_ArrayHandleCounting(0,ARRAY_SIZE);
