...
#include <dax/cont/ArrayContainerControlPermutation1.h>
...
struct TemplatedTests
{
  typedef dax::cont::internal::ArrayContainerControl<
      T, dax::cont::ArrayContainerControlTagPermutation> ArrayContainerType;
  ...
  void PermutationAllocation()
  {
    ...
    const ValueType PERMUTATION_ALLOC_VALUE = dax::cont::VectorFill<ValueType>(548);
    SetContainer(arrayContainer, PERMUTATION_ALLOC_VALUE);
    DAX_TEST_ASSERT(CheckContainer(arrayContainer, PERMUTATION_ALLOC_VALUE),
...
void TestArrayContainerControlPermutation1()
{
...
int UnitTestArrayContainerControlPermutation1(int, char *[])
{
  return dax::cont::internal::Testing::Run(TestArrayContainerControlPermutation1);
}
