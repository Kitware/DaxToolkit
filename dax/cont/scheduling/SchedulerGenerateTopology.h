...
#ifndef __dax_cont_scheduling_ScheduleGenerateTopology_h
#define __dax_cont_scheduling_ScheduleGenerateTopology_h
...
#include <dax/exec/internal/kernel/GenerateTopologyWorklets.h>
...
public:
  ...
  DAX_CONT_EXPORT Scheduler(
      const Scheduler<DeviceAdapterTag,
          dax::cont::scheduling::ScheduleGenerateTopologyTag>& other ):
...
DAX_CONT_EXPORT void GenerateNewTopology(
    dax::cont::ScheduleGenerateTopology<WorkletType,DeviceAdapterTag>& newTopo,
...
#endif //__dax_cont_scheduling_ScheduleGenerateTopology_h
...
DAX_CONT_EXPORT void Invoke(WorkletType w, _dax_pp_params___(a)) const
  {
  //we are being passed dax::cont::ScheduleGenerateTopology,
