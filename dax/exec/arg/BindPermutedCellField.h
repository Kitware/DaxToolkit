...
class BindPermutedCellField
    : public dax::exec::arg::ArgBase< BindPermutedCellField<WorkletType, ControlInvocationParams, N> >
{
  typedef dax::exec::arg::ArgBaseTraits< BindPermutedCellField< WorkletType, ControlInvocationParams, N > > Traits;
...
template <typename WorkletType, typename ControlInvocationParams,  int N >
struct ArgBaseTraits< BindPermutedCellField<WorkletType, ControlInvocationParams, N> >
{
private:
