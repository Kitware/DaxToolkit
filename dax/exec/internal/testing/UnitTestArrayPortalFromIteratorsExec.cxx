...
struct TemplatedTests
{
  ...
  ValueType ExpectedValue(dax::Id index, ComponentType value) {
    return dax::exec::VectorFill<ValueType>(index + value);
  }
  ...
  void operator()()
  {
    ...
    dax::exec::internal::ArrayPortalFromIterators<ValueType *>
        portal(array, array+ARRAY_SIZE);
    dax::exec::internal::ArrayPortalFromIterators<const ValueType *>
