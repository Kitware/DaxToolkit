...
dax::exec::internal::TopologyUnstructured<dax::exec::CellHexahedron>
             ...
             )
{
  ...
  points.clear();
  for(dax::Id i=0; i <dax::exec::internal::numberOfPoints(uniform); ++i)
    {
  ...
  topology.clear();
  for(dax::Id i=0; i <dax::exec::internal::numberOfCells(uniform); ++i)
    {
