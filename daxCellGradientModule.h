...
=========================================================================*/
#ifndef __daxCellGradientModule_h
#define __daxCellGradientModule_h

#include "daxModule.h"

/// Temporary module until we start supporting auto-generation of modules from
/// the functor.
class daxCellGradientModule : public daxModule
{
public:
  daxCellGradientModule();
...
private:
  daxDefinePtrMacro(daxCellGradientModule);
  std::string Code;
  std::string Name;
};
